...
public class ReportApplication {
    ...
    public static String run() throws Exception {
        ...
        BufferedReader custReader = new BufferedReader(new FileReader(custPath.toFile()));
        ...
        List<String> prodLines = Files.readAllLines(prodPath);
        ...
        Scanner shipScanner =new Scanner(shipPath.toFile());
        ...
        try {
            BufferedReader promoReader = new BufferedReader(new FileReader(promoPath.toFile()));
        ...
        BufferedReader ordReader = new BufferedReader(new FileReader(ordPath.toFile()));
        ...
        for (Map<String, Object> o : orders) {
            ...
            double basePrice = prod.containsKey("price") ?
                    (Double) prod.get("price") : (Double) o.get("unit_price");
        ...
        for (String cid : sortedCustomerIds) {
            ...
            for (Map<String, Object> item : items) {
                ...
                if (prod != null && prod.containsKey("taxable") &&
                        !(Boolean) prod.get("taxable")) {
                    allTaxable = false;
                    break;
                }
            }
            ...
            if (allTaxable) {
                ...
                for (Map<String, Object> item : items) {
                    Map<String, Object> prod = products.get(item.get("product_id"));
                    if (prod != null &&
                            (!(prod.containsKey("taxable")) || (Boolean) prod.get("taxable"))) {
                        double itemPrice = prod.containsKey("price") ?
                                (Double) prod.get("price") : (Double) item.get("unit_price");
